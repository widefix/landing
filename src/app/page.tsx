              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="190" height="45" viewBox="0 0 295.299 66.068">
                <defs>
                  <linearGradient id="2DERaw" x1="0.103" y1="1.006" x2="1.092" y2="-0.156" gradientUnits="objectBoundingBox">
                    <stop offset="0" stop-color="#a03c95" stop-opacity="0"></stop>
                    <stop offset="1" stop-color="#49c7f2"></stop>
                  </linearGradient>
                ...
                <g transform="translate(-903.897 -807.225)">
                  ...
                  </g><text transform="translate(1002.196 843.073)" font-size="33" font-family="Avenir-Medium, Avenir"
                    font-weight="500" fill="#000">
                    <tspan x="0" y="0" letter-spacing="0.23em">WORSHI</tspan>
                    <tspan y="0">P</tspan>
                  </text><text transform="translate(1098.316 865.3)" font-size="14" font-family="Avenir-Book, Avenir"
                    fill="#000">
                    <tspan x="-87.479" y="0" letter-spacing="1.75em">ONLIN</tspan>
                    <tspan y="0">E</tspan>
                  </text>
                  <g transform="translate(903.897 807.225)">
                    <path
